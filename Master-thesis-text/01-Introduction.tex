...
W rozdziale \Ref{c2} przedstawiono podstawowe pojęcia zastosowane w redagowaniu pracy magisterskiej. Terminy te zostały wyjaśnione, aby bez problemu zrozumieć bardziej skomplikowane zagadnienia. Opisane są tutaj główne komponenty wchodzące wchodzące w skład tego rozdziału, a także inne narzędzia, o których jest mowa w późniejszych rozdziałach.

W rozdziale \Ref{c3} zawarto teorię dotyczącą App Inventora. Opisana jest tutaj między innymi architektura aplikacji.
